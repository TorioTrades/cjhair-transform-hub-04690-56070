...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="bg-gradient-to-b from-secondary/30 to-secondary/50 pt-12 md:pt-20 pb-6 md:pb-8 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-8 md:mb-12">
          ...
          <div className="space-y-3 md:space-y-4">
            <div className="flex items-center space-x-2 mb-3 md:mb-4">
              ...
              <div>
                <h3 className="font-serif font-bold text-xl md:text-2xl text-foreground">Hair Lounge</h3>
          ...
          <div>
            ...
            <ul className="space-y-3 md:space-y-4">
              ...
              <li className="flex items-start space-x-2 md:space-x-3">
                <Clock className="w-4 h-4 md:w-5 md:h-5 text-primary flex-shrink-0 mt-1" />
                <div className="text-sm md:text-base text-muted-foreground">
